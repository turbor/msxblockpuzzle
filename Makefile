...
msxwood.crt:	bcdlib.asc gridbitmapmanipulators.asc piecelib.asc variablespace.asc bios.asc joystick.asc pieces.asc gameover.asc msxwood.asc testbcdlib.asc routines.asc charanimation.asc boxcopy.asc bigscroller.asc vram-*.txt logo.asc
